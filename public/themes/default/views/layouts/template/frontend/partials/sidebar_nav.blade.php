<div class="mt-layout-sidebar --scroll" ng-class="{'__visible': toggle}">
    ...
    <li><a href="/designers" class="mt-sidebar-link btn"><i class="mdi mdi-tshirt-v"></i>Designers</a></li>
    <li><a href="#" class="mt-sidebar-link btn"><i class="mdi mdi-trending-up"></i>Trending</a></li>
    <li><a href="/brands" class="mt-sidebar-link btn"><i class="mdi mdi-tshirt-v"></i>Brands</a></li>
